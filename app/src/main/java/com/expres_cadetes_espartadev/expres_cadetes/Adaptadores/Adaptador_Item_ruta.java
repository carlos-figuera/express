...
public class Adaptador_Item_ruta extends RecyclerView.Adapter<Adaptador_Item_ruta.ViewHolder> implements View.OnClickListener {
    ...
    public Adaptador_Item_ruta(List<Mo_Items_ruta> lista_ruta, RecyclerView recyclerView) {
    ...
    public void Acualizar(){
        ...
        adaptador_item_ruta = new Adaptador_Item_ruta(bd_express.get_Items_de_ruta(),recyclerView);
